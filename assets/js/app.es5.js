...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // materialize pushpin
    var pushpinElems = document.querySelectorAll('.post-toc');
    var pageHeight = $(document.body).height();
    var tocHeight = $('.post-toc').length ? $('.post-toc').height() : 0;
    var footerOffset = $('.page-footer').first().length ? $('.page-footer').first().offset().top : 0;
    var bottomOffset = footerOffset - tocHeight;
    var offsetFromTop = $('.post-toc').length > 0 ? $('.post-toc').offset().top : 0;
    // console.log(tocHeight, footerOffset, bottomOffset, offsetFromTop );
    // init pushpin
    var pushpinInstances = M.Pushpin.init(pushpinElems, {
